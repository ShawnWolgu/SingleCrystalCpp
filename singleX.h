...
class Slip {
    public:
        ...
        Matrix3d schmidt;
        vector<double> dd_hardening_params;
        ...
        void update_acc_strain();
        void update_strain(Matrix3d stress_tensor, Matrix3d deform_grad_elas);
        void cal_strain_ddh(Matrix3d stress_tensor, Matrix3d deform_grad_elas, vector<Slip> &slip_sys, double lattice_cons);
        void cal_shear_modulus(Matrix6d elastic_modulus);
        void update_dislocation();
